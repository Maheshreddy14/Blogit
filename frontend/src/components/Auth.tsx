...
import { SignupInput } from '@m4hez/blog-common'
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className='pt-5'>
                    <LabelledInput label="Username" placeholder="Mahesh reddy..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            username: e.target.value
                        })
                    }} />
                    {type ==='signup' ?<LabelledInput label="Email" placeholder="maasha@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
